...
#<_second_position_to_probe> =  (absolute value to probe to in the positioning wcs)
#<_z_clearance_position> =  (absolute value to move to in the positioning wcs)
#<_second_x_position> =  (absolute value to begin probing from in the positioning wcs)
#<_second_y_position> =  (absolute value to begin probing from in the positioning wcs)
#<_second_z_position> =  (absolute value to begin probing from in the positioning wcs)
#<_measuring_wcs> =  (given with number between 1 and 500 to be used with G54.1 Pxxx, set equivalent to the positining wcs if same)
